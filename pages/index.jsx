                ...
                <div className={`${style.container} ${light ? style.container_light : ''}`}>
                    ...
                    <div className={style.me}>
                        ...
                        <div className={style.badges} style={(user?.status?.emote || user?.status?.text) ? { marginTop: 8 } : { marginTop: width > 540 ? 14 : 4 }}>
                            ...
                            <button className={`${style.badge} ${light ? style.badge_light : ''}`} title='https://github.com/' onClick={() => window.open('https://github.com/')}> <HiOutlineCode style={{ height: 22, width: 22, marginRight: 4 }} /> Developer </button>
                        </div>
                    </div>
                    <div className={style.content}>
                        <div className={`${style.readme} ${light ? style.readme_light : ''}`}>
                            ...
                            <div style={{ marginTop: 8, marginLeft: 12, display: 'block' }}>
                                ...
                                I'm <strong>male</strong> and my pronouns are <strong>He/They</strong> <img src='https://cdn.discordapp.com/emojis/959513603134853180.png?size=20&quality=lossless' style={{ position: 'relative', top: 3 }} draggable={false} />, in my free time I  love to <strong>code Discord bots</strong>, websites in general and I'm a <strong>single developer</strong>. <img src='https://cdn.discordapp.com/emojis/959513603009028146.png?size=20&quality=lossless' style={{ position: 'relative', top: 3 }} draggable={false} />
